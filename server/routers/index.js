// Importa o módulo 'teskRouter.js' e atribui à variável 'routertesks'
const routertesks = require("./teskRouter.js");
...
module.exports = function (app, express) {
  ...
  // Adiciona o roteador 'routertesks' (com as rotas definidas) ao aplicativo Express
  app.use(routertesks);
};